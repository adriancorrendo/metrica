...
```{r scatter_plot PO, fig.width=6, fig.height=5, dpi=120}
...
```{r scatter_plot OP, fig.width=6, fig.height=5, dpi=120}
scatter_plot(data = wheat, 
             obs = obs, 
             pred = pred,
             orientation = "OP")
...
```{r scatter_plot custom, fig.width=6, fig.height=5, dpi=120}
scatter_plot(data = wheat, 
             obs = obs, 
             pred = pred,
             orientation = "OP")+
...
```{r bland-altman, fig.width=6, fig.height=5, dpi=120}
...
```{r metrics time-series, fig.width=6, fig.height=5, dpi=120}
set.seed(165)
...
MASE(data = wheat_time, obs = obs, pred = pred, 
              naive_step = 1, tidy = FALSE, time = "Year", oob_mae = 50)
...
```{r scatter_plot, fig.width=6, fig.height=5, dpi=120}
scatter_plot(data = wheat,
             obs = obs, 
             pred = pred)
