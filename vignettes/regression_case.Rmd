...
# for a series of 20 years from 2001 to 2020. 
# Thus, we may get a random sample from the whear data set and assume they represent 
# the time series of interest. Therefore, we create a new `time` variable called 
# `Year` that will serve to sort the observations
