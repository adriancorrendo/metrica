...
#' @note Adapted from apsimx. We recommend to check and use the function apsimx::read.apsimx() as an alternative.
#' @note (source: https://github.com/femiguez/apsimx by F. Miguez).
...
import.apsim.db <- function(filename = "", folder = ".", value = "report", simplify = TRUE){
