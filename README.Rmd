...
should ideally come from out-of-bag samples (unseen by training sets) to avoid overestimation of the 
...
[5. Import APSIM files](https://adriancorrendo.github.io/metrica/articles/apsim_open.html) <br/>
...
```{r warning=F, message=F, fig.height=6, fig.width=7, dpi=300}
df <- metrica::wheat
