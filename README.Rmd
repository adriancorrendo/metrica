...
The **metrica** package contains +40 functions . Most of them work with only two arguments: `observed`(a.k.a. actual, measured, truth, target) and `predicted` (a.k.a. simulated, fitted) values. For now, included functions cover the world of "regression error" metrics (i.e. prediction performance for continuous variables). Classification error metrics coming soon. <b/>
